...
//   const [profiles, setProfileies] = useState([]); // استخدم التسمية الجمع لأنك تخزن مجموعة من المواد
//   const [price_beam, setPriceBeam] = useState(0); // استخدم التسمية الجمع لأنك تخزن مجموعة من المواد
...
//       formData.append("Renovation", Renovation === "Yes"); // تحويل القيمة إلى Boolean
...
//       // إعادة تعيين الحقول إلى القيم الافتراضية بعد النجاح
//       setName("");
//       setImage(null);
//       setFrom("");
//       setCode("");
...
//               onChange={(e) => setImage(e.target.files[0])} // تحديث القيمة إلى ملف
//             />
//           </div>
//           <div>
//             <input
...
//   const [profile, setProfile] = useState("");
//   const [profiles, setProfileies] = useState([]); // استخدم التسمية الجمع لأنك تخزن مجموعة من المواد
//   const [priceBeam, setPriceBeam] = useState(0); // حالة جديدة لحفظ الناتج المحسوب
...
//       setPricePermeter("");
//       setProfile("");
//       setPriceBeam(0); // إعادة تعيين الناتج المحسوب
//     } catch (error) {
//       toast.error(error.response.data.message);
//     }
//   };
